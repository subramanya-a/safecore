...
export default {
  page: {
    title: 'Welcome to SafeCore',
    description: (
      <>
      <p align="justify">This site is your gateway to mastering cybersecurity, ethical hacking, and software development. Designed for those who love the challenge of Capture The Flag (CTF) competitions, aim to achieve recognized certifications, or seek to sharpen their skills with the latest hacking tools, this platform offers a wealth of resources to help you grow in the field.</p>
      <p align="justify">Explore tutorials and guides on ethical hacking techniques, dive into CTF challenges to test your skills, and discover tools that can enhance your penetration testing and defensive strategies. Whether you’re pursuing cybersecurity certifications or looking to integrate secure coding practices into your software development workflow, you'll find content here that bridges theory with practical application.</p>
      <p align="justify">Stay ahead in the world of cybersecurity, continuously improve your skills, and join a community of like-minded individuals committed to making the digital world safer.</p>
      </>),
  },
  carousel: [
    // {
    ...
    //       <a href="https://docs.strapi.io/cms/quick-start" target="_blank">This site is your gateway to mastering cybersecurity, ethical hacking, and software development. Designed for those who love the challenge of Capture The Flag (CTF) competitions, aim to achieve recognized certifications, or seek to sharpen their skills with the latest hacking tools, this platform offers a wealth of resources to help you grow in the field.</a>
